...
typedef enum {
    HANJP_JPNGSEONG_KIYEOK = 0x11A8,
    HANJP_JONGSEONG_SIOS = 0x11BA,
    HANJP_JONGSEONG_PHIEUPH = 0x11C1,
    HAMJP_JONGSEONG_NIEUN = 0x11AB,
    HANJP_JONGSEONG_IEUNG = 0x11BC,
    HANJP_JONGSEONG_MIEUM = 0x11B7
} hanjpJongseongId;
